...
import { Plus, ExternalLink, Search, Star, Edit, Trash2 } from "lucide-react"
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
           <span className="text-orange-500 font-bold text-5xl">DSS</span>
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Библиотека Книг</h1>
              <p className="text-gray-600">Система управления личной коллекцией</p>
            </div>
          </div>
